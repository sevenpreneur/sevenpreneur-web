...
// Bar color. Per-item overridable via the `--share-bar-color` CSS variable
// (set `style={{ "--share-bar-color": "#1f5f4e" }}` on a ShareBarListItem);
// falls back to the shadcn chart token.
const BAR_COLOR = "var(--share-bar-color, var(--chart-2))";
